...
namespace HRMS.Web.Api.Controllers.Utilities
{
    ...
    public class AuditsController : ControllerBase
    {
        ...
        {
            HRMS.Shared.Wrapper.IResult<string> data = await _auditService.ExportToExcelAsync(_currentUserService.UserName, searchString, searchInOldValues, searchInNewValues);
            return Ok(data);
        }
    }
}
