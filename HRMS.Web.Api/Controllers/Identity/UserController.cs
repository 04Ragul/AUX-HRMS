...
namespace HRMS.Web.Api.Controllers.Identity
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            HRMS.Shared.Wrapper.Result<List<HRMS.Shared.Utilities.Responses.Identity.UserResponse>> users = await _userService.GetAllAsync();
            return Ok(users);
        }
        ...
        {
            HRMS.Shared.Wrapper.IResult<HRMS.Shared.Utilities.Responses.Identity.UserResponse> user = await _userService.GetAsync(id);
            return Ok(user);
        }
        ...
        {
            HRMS.Shared.Wrapper.IResult<HRMS.Shared.Utilities.Responses.Identity.UserRolesResponse> userRoles = await _userService.GetRolesAsync(id);
            return Ok(userRoles);
        }
